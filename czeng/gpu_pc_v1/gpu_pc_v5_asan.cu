...
int main(int argc, char** argv){
	...
	int grid_dim_merge = atoi(argv[4]);
	int block_dim_merge = atoi (argv[5]);
...
********************************************************/
	...
	cudaEvent_t time_search_memcpyH2D_start, time_search_memcpyH2D_stop, time_search_memcpyD2H_start, time_search_memcpyD2H_stop, time_comp_start, time_comp_stop,time_exp_start,time_exp_stop;
...
********************************************************/
	...
	cout<<endl<<">>>>>>[Stage 1: Search] "<<"grid_dim: "<<grid_dim<<", block_dim: "<<block_dim<<endl;
...
********************************************************/
	...
	cudaEventElapsedTime(&time7, time_clean_start, time_clean_stop);
